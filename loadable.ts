import type { CustomElement, CustomElementClass } from '@github/catalyst/src/custom-element.js';
import { createAbility } from '@github/catalyst/src/ability.js';
...
export interface Loadable extends CustomElement {
    src: string;
